      ...
      {products.map((product, index) => {
        ...
        return (
          ...
          >
            ...
            {showAddToCart ? (
              <div className="bg-orange-600 hover:bg-orange-700 rounded-b-xl text-white h-15 flex items-center justify-center"
              ...
              <div className="relative">
                <Trash2 
                      ...
                      />
                  <div className="bg-orange-600 rounded-b-xl text-white px-2 h-15 flex items-center hover:bg-orange-700  ">
